...
public class Rare {
	  ...
	  if(item1.equalsIgnoreCase("helmet") || item1.equalsIgnoreCase("chestplate") || item1.equalsIgnoreCase("leggings") || item1.equalsIgnoreCase("boots")) {
		  ...
		  armor.setLore(Arrays.asList(new String[] {"§7Health: " + getRareHealth(), getTierColor(tier) + "§oˮArmour forged by", getTierColor(tier) + "§o" + getRandomItemLore(), getTierColor(tier) + "Rare"}));
		  item.setItemMeta(armor);
		  return getRareEnchantment(item, item1);
		  
	  }
	    if(item1.equalsIgnoreCase("axe") || item1.equalsIgnoreCase("sword")) {
    		  ItemMeta armor = item.getItemMeta();
    		  armor.setDisplayName(getTierColor(tier) + getRandomItemName(item1));
    		  armor.setLore(Arrays.asList(new String[] { "§7Damage: " + getRareDamage(),getTierColor(tier) + "§oˮWeapon forged by", getTierColor(tier) + "§o" + getRandomItemLore(), getTierColor(tier) + "Rare"}));
    		  item.setItemMeta(armor);
    		  return getRareEnchantment(item, item1);
	  }
...
public static ItemStack getRareEnchantment(ItemStack s, String s1) {
...
public static int getRareHealth() {
	  Random r = new Random();
      int Chance = r.nextInt(250);
      int max = r.nextInt(345-215) + 215;
      int lvl5 = r.nextInt(290-215) + 215;
      int lvl3 = r.nextInt(267-215) + 215;
      int lvl2 = r.nextInt(223-100) + 215;
      if(Chance >= 1 && Chance < 50) {
      	return max;
      }
      if(Chance >=50 && Chance < 100) {
...
public static int getRareDamage() {
	  Random r = new Random();
      int Chance = r.nextInt(250);
      int max = r.nextInt(69-43) + 43;
      int lvl5 = r.nextInt(63-43) + 43;
      int lvl3 = r.nextInt(54-43) + 43;
      int lvl2 = r.nextInt(45-43) + 43;
      if(Chance >= 1 && Chance < 50) {
      	return max;
      }
      if(Chance >=50 && Chance < 100) {
