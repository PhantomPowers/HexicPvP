...
public class Common {
     	  ...
     	  public static ItemStack getItem() {
      	  ...
      	  if(item1.equalsIgnoreCase("helmet") || item1.equalsIgnoreCase("chestplate") || item1.equalsIgnoreCase("leggings") || item1.equalsIgnoreCase("boots")) {
      		  ...
      		  armor.setLore(Arrays.asList(new String[] {"§7Health: " + getCommonHealth(), getTierColor(tier) + "§oˮArmour forged by", getTierColor(tier) + "§o" + getRandomItemLore(), getTierColor(tier) + "Common"}));
      		  item.setItemMeta(armor);
      		  return getCommonEnchantment(item, item1);
      		  
      	  }
      	    if(item1.equalsIgnoreCase("axe") || item1.equalsIgnoreCase("sword")) {
          		  ItemMeta armor = item.getItemMeta();
          		  armor.setDisplayName(getTierColor(tier) + getRandomItemName(item1));
          		  armor.setLore(Arrays.asList(new String[] {"§7Damage: " + getCommonDamage(), getTierColor(tier) + "§oˮWeapon forged by", getTierColor(tier) + "§o" + getRandomItemLore(), getTierColor(tier) + "Common"}));
          		  item.setItemMeta(armor);
          		  return getCommonEnchantment(item, item1);
      	  }
...
public static String getRandomItemLore() {
	  ...
	  public static ItemStack getCommonEnchantment(ItemStack s, String s1) {
	  ...
	  public static int getCommonHealth() {
		  Random r = new Random();
	        int Chance = r.nextInt(250);
	        int max = r.nextInt(100-20) + 20;
	        int lvl5 = r.nextInt(75-20) + 20;
	        int lvl3 = r.nextInt(50-20) + 20;
	        int lvl2 = r.nextInt(30-20) + 20;
	        if(Chance >= 1 && Chance < 50) {
	        	return max;
	        }
	        if(Chance >=50 && Chance < 100) {
	  ...
	  public static int getCommonDamage() {
		  Random r = new Random();
	        int Chance = r.nextInt(250);
	        int max = r.nextInt(20-3) + 3;
	        int lvl5 = r.nextInt(14-3) + 3;
	        int lvl3 = r.nextInt(8-3) + 3;
	        int lvl2 = r.nextInt(5-3) + 3;
	        if(Chance >= 1 && Chance < 50) {
	        	return max;
	        }
	        if(Chance >=50 && Chance < 100) {
